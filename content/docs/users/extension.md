---
title: "Extension"
description: "Bitindi extension offers a convenient way to interact with dapps on Bitindi chain."
lead: ""
...
Bitindi extension is kind of like Metamask, but for Multi chain. You can get it for **[Chrome](#)** and **[Firefox](#)**.
...
If you are a developer, check out the [integration guide](https://github.com/bitindi).

### What is Bitindi Extension for?
Bitindi extension is a browser extension that allows one to safely interact with Multi chain ecosystem
without exposing the private keys. It can:
- Self-Custodial Multi-Chain Wallet.
- The Bitindi Wallet is an extension for accessing Bitindi, Bitcoin, Ethereum Web3, Rootstock, NEAR, Polygon, Binance Smart Chain, and Arbitrum applications in your browser. This MetaMask alternative supports multiple blockchains and provides the easiest way to flip between BTC, ETH/ERC20s, RSK, NEAR, TERRA, Avalanche and Polygon tokens with built-in one-click atomic swaps. 
